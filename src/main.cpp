...
uint256 hashGenesisBlock("0xab381f4237ea7ff977a10a2d91794427429c52ac1dbc065d471b4966a69c8772");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MacroCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MacroCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 50000); // MacroCoin: 50k blocks

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // MacroCoin: 24 hours
static const int64 nTargetSpacing = 120; // MacroCoin: 60 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // MacroCoin difficulty adjustment protocol switch
    ...
    // MacroCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal macrocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MacroCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis Block:
        // block.nTime = 1391035538 
        // block.nNonce = 2085228763 
        //block.GetHash = ab381f4237ea7ff977a10a2d91794427429c52ac1dbc065d471b4966a69c8772
        //CBlock(hash=ab381f4237ea7ff977a1, PoW=000008ee79be83346733, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=cf4f8126c2, nTime=1391035538, nBits=1e0ffff0, nNonce=2085228763, vtx=1)
        //CTransaction(hash=cf4f8126c2, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104115765642032397468204a616e2032303134)
        //CTxOut(nValue=50.00000000, scriptPubKey=040184710fa689ad5023690c80f3a4)
        //vMerkleTree: cf4f8126c2 


        // Genesis block
        const char* pszTimestamp = "Wed 29th Jan 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xcf4f8126c243d9d983370cf78a5638028f77129d9b05e90c1e2f482524011126"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // MacroCoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // MacroCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
